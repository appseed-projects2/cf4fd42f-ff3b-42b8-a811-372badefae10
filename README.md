...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-15 16:27`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cf4fd42f-ff3b-42b8-a811-372badefae10.git
$ cd cf4fd42f-ff3b-42b8-a811-372badefae10
```
